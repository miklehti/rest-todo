...
@Sql(executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD, scripts = { "/datasets/DeleteAll.sql",
        "/datasets/init.sql" })
...
public class TodoControllerTest {
    ...
    public void getAllTodos() throws MalformedURLException {
        ...
        ResponseEntity<List<Todo>> response2 = template.exchange(this.base.toString(), HttpMethod.GET, null,
    ...
    public void deleteTodo() throws MalformedURLException {
        ...
        this.base = new URL(baseUrl + "/alltodos");
        ResponseEntity<List<Todo>> response3 = template.exchange(this.base.toString(), HttpMethod.GET, null,
                new ParameterizedTypeReference<List<Todo>>() {
                });
